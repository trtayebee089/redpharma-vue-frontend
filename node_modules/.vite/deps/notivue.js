...
var CLASS_PREFIX = "Notivue__";
var DEFAULT_DURATION = 6e3;
var NotificationTypeKeys = {
  SUCCESS: "success",
  ERROR: "error",
  WARNING: "warning",
  INFO: "info",
...
var error = __spreadProps(__spreadValues({}, success), {
  ariaLive: "assertive",
  ariaRole: "alert"
});
var promise = __spreadProps(__spreadValues({}, success), {
  duration: Infinity
});
var warning = __spreadProps(__spreadValues({}, error), {
  ariaLive: "polite"
});
var info = __spreadValues({}, success);
...
var isStatic = (type) => type === NotificationTypeKeys.SUCCESS || type === NotificationTypeKeys.ERROR || type === NotificationTypeKeys.WARNING || type === NotificationTypeKeys.INFO;
var internalKeys = [
  "timeout",
  "resumedAt",
  "remaining",
...
var notivueInstanceInjectionKey = Symbol();
var notivueInjectionKey = Symbol();
...
var keyboardInjectionKey = Symbol("");
var focusableEls = 'a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), [tabindex="0"]';
var DEFAULT_PROPS$2 = {
  comboKey: "n",
  handleClicks: true,
...
var NotivueClientOnly = defineComponent({
  setup(_, { slots, attrs }) {
...
var _hoisted_1$9 = ["data-notivue-align", "aria-label"];
var _hoisted_2$9 = ["data-notivue-item", "aria-setsize", "aria-posinset"];
var _hoisted_3$6 = ["aria-label", "tabindex", "data-notivue-container"];
...
var _hoisted_1$4 = createBaseVNode("path", { d: "M12, 6c0, 3.313 -2.687, 6 -6, 6c-3.313,-0 -6,-2.688 -6,-6c0,-3.313 2.688,-6 6,-6c3.313,-0 6,2.687 6,6Zm-0.923,-0c-0,-2.803 -2.274,-5.077 -5.077,-5.077c-2.803,0 -5.077,2.274 -5.077,5.077c0,2.803 2.274,5.077 5.077,5.077c2.803,-0 5.077,-2.274 5.077,-5.077Z" }, null, -1);
...
var _hoisted_3$4 = createBaseVNode("path", { d: "M6,9.228c-0.316,0 -0.577,-0.26 -0.577,-0.577c0,-0.316 0.261,-0.577 0.577,-0.577c0.316,0 0.577,0.261 0.577,0.577c-0,0.317 -0.261,0.577 -0.577,0.577Z" }, null, -1);
var _hoisted_4$2 = [
  _hoisted_1$4,
  _hoisted_2$4,
  _hoisted_3$4
...
var _hoisted_1$3 = createBaseVNode("path", { d: "M6, 0c3.313, 0 6, 2.687 6, 6c-0, 3.313 -2.687, 6 -6, 6c-3.313,-0 -6,-2.687 -6,-6c0,-3.313 2.687,-6 6,-6Zm0, 0.96c-2.783, 0 -5.04, 2.257 -5.04, 5.04c0, 2.783 2.257, 5.04 5.04, 5.04c2.783, 0 5.04,-2.257 5.04,-5.04c-0,-2.783 -2.257,-5.04 -5.04,-5.04Z" }, null, -1);
...
var _hoisted_3$3 = createBaseVNode("path", { d: "M6, 2.46c-0.428, 0 -0.78, 0.352 -0.78, 0.78c-0, 0.428 0.352, 0.78 0.78, 0.78c0.428, 0 0.78,-0.352 0.78,-0.78c-0,-0.428 -0.352,-0.78 -0.78,-0.78Z" }, null, -1);
var _hoisted_4$1 = [
  _hoisted_1$3,
  _hoisted_2$3,
  _hoisted_3$3
...
var _hoisted_1$2 = createBaseVNode("path", {
...
var _hoisted_1$1 = createBaseVNode("line", {
  x1: "18",
  y1: "6",
  x2: "6",
  y2: "18"
}, null, -1);
var _hoisted_2$1 = createBaseVNode("line", {
  x1: "6",
  y1: "6",
  x2: "18",
  y2: "18"
...
var ionProps = __spreadProps(__spreadValues({}, svgProps), {
  fill: "currentColor",
  viewBox: "0 0 12 12"
});
var featherProps = __spreadProps(__spreadValues({}, svgProps), {
  stroke: "currentColor",
  "stroke-width": 2,
...
var lightTheme = __spreadProps(__spreadValues(__spreadValues({}, layout), shadow), {
  "--nv-global-bg": "#FFF",
  "--nv-global-fg": "#171717",
...
var pastelTheme = __spreadProps(__spreadValues(__spreadValues({}, layout), shadow), {
...
var materialTheme = __spreadProps(__spreadValues(__spreadValues({}, layout), shadow), {
...
var darkTheme = __spreadProps(__spreadValues({}, layout), {
  "--nv-border-width": "1px",
  "--nv-global-bg": "#1F1F1F",
...
var slateTheme = __spreadProps(__spreadValues({}, layout), {
  "--nv-border-width": "1px",
  "--nv-global-bg": "#20252E",
...
var DEFAULT_NOTIFICATIONS_PROPS = {
  icons: () => filledIcons,
  theme: () => lightTheme,
  hideClose: false,
  closeAriaLabel: "Close"
};
var _hoisted_1 = ["data-notivue", "data-notivue-has-title"];
var _hoisted_2 = ["aria-live", "role"];
