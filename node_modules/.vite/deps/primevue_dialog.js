import {
  script as script4
} from "./chunk-7HCHOPOB.js";
import {
  BaseDirective,
  Ripple,
  script as script2,
  script2 as script3
} from "./chunk-A64BMMDG.js";
import {
  BaseStyle,
  script
...
// node_modules/primevue/dialog/style/dialogstyle.esm.js
var inlineStyles = {
        ...
        "default": withCtx(function() {
          return [_ctx.visible ? withDirectives((openBlock(), createElementBlock("div", mergeProps({
            ...
            return [_ctx.header ? (openBlock(), createElementBlock("span", mergeProps({
              ...
              "class": _ctx.cx("title")
            }, _ctx.ptm("title")), toDisplayString(_ctx.header), 17, _hoisted_23)) : createCommentVNode("", true)];
            ...
            type: "button"
          }, _objectSpread2(_objectSpread2({}, _ctx.closeButtonProps), _ctx.ptm("closeButton")), {
            "data-pc-group-section": "headericon"
          ...
          })], 16, _hoisted_4)), [[_directive_ripple]]) : createCommentVNode("", true)], 16)], 16)) : createCommentVNode("", true), createBaseVNode("div", mergeProps({
            ref: $options.contentRef,
            "class": [_ctx.cx("content"), _ctx.contentClass],
            style: _ctx.contentStyle
          }, _objectSpread2(_objectSpread2({}, _ctx.contentProps), _ctx.ptm("content"))), [renderSlot(_ctx.$slots, "default")], 16), _ctx.footer || _ctx.$slots.footer ? (openBlock(), createElementBlock("div", mergeProps({
            key: 1,
            ref: $options.footerContainerRef,
            "class": _ctx.cx("footer")
          }, _ctx.ptm("footer")), [renderSlot(_ctx.$slots, "footer", {}, function() {
            return [createTextVNode(toDisplayString(_ctx.footer), 1)];
          })], 16)) : createCommentVNode("", true)], 64))], 16, _hoisted_13)), [[_directive_focustrap, {
            disabled: !_ctx.modal
