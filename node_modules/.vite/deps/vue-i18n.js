...
function vTDirective(i18n) {
  const _process = (binding) => {
    if (true) {
      warnOnce(getWarnMessage2(I18nWarnCodes.DEPRECATE_TRANSLATE_CUSTOME_DIRECTIVE));
    }
...
function createI18n(options = {}) {
  ...
  if (__legacyMode) {
    warnOnce(getWarnMessage2(I18nWarnCodes.DEPRECATE_LEGACY_MODE));
  }
...
function useI18n(options = {}) {
  ...
  if (composer == null) {
    ...
    if (scope === "local") {
      warn(getWarnMessage2(I18nWarnCodes.DUPLICATE_USE_I18N_CALLING));
    }
  }
  return composer;
}
